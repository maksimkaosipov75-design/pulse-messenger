  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-gray-800 rounded-2xl p-8 text-center w-80 shadow-2xl border border-gray-700">
        ...
        <p className="text-sm text-gray-400 mb-8">{t('call.calling')}</p>
        ...
        <button
          onClick={() => endCall()}
          className="w-16 h-16 rounded-full bg-red-500 hover:bg-red-600 flex items-center justify-center transition-colors mx-auto shadow-lg shadow-red-500/30"
        >
