    ...
    <div className="h-full flex flex-col bg-gray-900">
      ...
      <div className="flex items-center gap-2 px-4 py-3 border-b">
        ...
        <input
          ...
          className="flex-1 bg-transparent text-white placeholder:text-ink-faint text-sm focus:outline-none"
        />
        <button onClick={close} className="p-1 rounded hover:bg-elev">
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        {!isSearching && query && results.length === 0 && (
          <div className="flex flex-col items-center justify-center h-64 text-ink-dim">
        ...
        {results.map((result, i) => (
          <button
            ...
            className="w-full text-left px-4 py-3 hover:bg-elev transition-colors border-b border-gray-800"
          >
