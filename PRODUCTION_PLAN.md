...
> **Статус на 2026-06-10:** P0 выполнен полностью; P1 (Linux) выполнен —
> AppImage/deb собираются, релизы подписываются, автообновления работают;
> P2 выполнен (Rust + Vitest тесты, CI, миграции, обработка ошибок,
> оффлайн-очередь); P3 выполнен (README, CONTRIBUTING, SECURITY, LICENSE,
> CHANGELOG). Дополнительно: replay-защита и пиннинг ключей отправителя,
> исправлена доставка текстовых сообщений по сети.
> **Следующий этап — P1 (Android).**
